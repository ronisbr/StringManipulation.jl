...
@testset "Convert Decoration to String" begin
    d = Decoration(;
        foreground = "35", background = "48;5;243", underline = StringManipulation.active
    )
    ...
    d = Decoration(;
        foreground = "35", background = "48;5;243", underline = StringManipulation.inactive
    )
    ...
    d = Decoration(;
        foreground = "", background = "45", reversed = StringManipulation.active
    )
    ...
    d = Decoration(;
        foreground = "", background = "45", reversed = StringManipulation.inactive
    )
...
@testset "Parse Decorations" begin
    ...
    decoration = parse_decoration(
        "\e[35m\e[48;5;243;3mThis text should be discarded\e[4;27m"
    )
...
@testset "Update Decorations" begin
    ...
    decoration = update_decoration(
        decoration, "\e[38;5;231mThis text should be discarded\e[48;5;243m"
    )
    @test decoration.foreground == "38;5;231"
    @test decoration.background == "48;5;243"
    @test decoration.underline == StringManipulation.unchanged
    ...
    decoration = update_decoration(
        decoration, "This also should \e[23mbe discarded\e[4;27m"
    )
    @test decoration.foreground == "38;5;231"
    @test decoration.background == "48;5;243"
    @test decoration.underline == StringManipulation.active
    ...
    decoration = Decoration()
    decoration = update_decoration(
        decoration, "\e[38;2;28;101;140;48;2;216;210;203mFirst decoration"
    )
    ...
    decoration = update_decoration(decoration, "\e[38;2;57;138;185;1mSecond decoration")
    ...
    new_decoration = Decoration(; background = "43", bold = StringManipulation.inactive)
